...
class upload_spss():
    ...
    def insert_sub_table(self, filename, varnames, valuetypes, width, float_width,
                         varLabels, valueLabels, vartypes,project_id,dataset_id):
        try:
            res = writer_information_tables()
